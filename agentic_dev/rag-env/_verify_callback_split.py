...
def main():
    # Monkeypatch TOOL_LOG_PATH ke temp file supaya script tidak mencemari
    # tool_calls.log produksi -- setiap run append synthetic fake log lines
    # ke log real, jadi fix dengan pakai temp file lokal.
    original_tool_log_path = query.TOOL_LOG_PATH
    query.TOOL_LOG_PATH = os.path.join(tempfile.gettempdir(), "verify_callback_split_test.log")
    ...
    try:
        ...
        # Restore original TOOL_LOG_PATH
        query.TOOL_LOG_PATH = original_tool_log_path
